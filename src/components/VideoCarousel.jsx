...
const VideoCarousel = () => {
    ...
    const handleLoadedData = (i,e)=>setLoadedData((prevData)=>[...prevData,e])
            ...
            <div key={list.id} id='slider' className=' sm:pr-20 pr-10'>
                <div className=' video-carousel_container'>
                    <div className=' w-full h-full flex-center rounded-3xl overflow-hidden bg-black'>
                        <video className={`${list.id === 2 && 'translate-x-44'} pointer-events-none`} id='video' preload='auto' playsInline={true} muted  ref={(el)=>(videoRef.current[index] = el)} 
                        onEnded={()=>{
